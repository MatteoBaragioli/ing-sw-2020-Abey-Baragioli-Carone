...
public class BuildUnderYourselfPowerTest {
    ...
    public void changePossibleOptions() {
        ...
        Player player = new Player("player1", Colour.BLUE, new GodCard("Zeus", 30, new ArrayList<TurnSequenceModifier>(), new StandardWin(), new NoSetUpCondition(), new ArrayList<TurnSequenceModifier>()));
