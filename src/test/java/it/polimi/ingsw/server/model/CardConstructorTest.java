...
public class CardConstructorTest {
    ...
    public void loadFX() {
        ...
        assertTrue(fx.get(OPPONENTS_CANT_MOVE_UP_IF_PLAYER_MOVES_UP).getClass().isInstance(new OpponentsCantMoveUpIfPlayerMovesUpPower()));
    ...
    public void loadActions() {
        ...
        for (int i = 0; i<actions.size(); i++)
            if (i==3)
                assertTrue(actions.get(i).getClass().isInstance(new OpponentsCantMoveUpIfPlayerMovesUpPower()));
            else
                assertTrue(actions.get(i).getClass().isInstance(new DoNothing()));
    ...
    public void createCard() {
        ...
        for (int i = 0; i<godCard.actions().size(); i++)
            if (i==3)
                assertTrue(godCard.actions().get(i).getClass().isInstance(new OpponentsCantMoveUpIfPlayerMovesUpPower()));
            else
                assertTrue(godCard.actions().get(i).getClass().isInstance(new DoNothing()));
