...
import it.polimi.ingsw.server.model.godPowers.fx.RemoveAdjacentBlockPower;
...
public class RemoveAdjacentBlockPowerTest {
    ...
    public void executeAction() throws IOException {
        ...
        aresPower.executeAction(player, communicationController, actionController, map, new ArrayList<Player>(), new ArrayList<WinCondition>());
    ...
    public void usePower() throws IOException {
        ...
        aresPower.usePower(player, communicationController, actionController, map, new ArrayList<Player>(), new ArrayList<WinCondition>(), false);
        assertTrue(player.turnSequence().removedBlocks().isEmpty());
        player.turnSequence().setChosenBox(map.position(3,4));
        aresPower.usePower(player, communicationController, actionController, map, new ArrayList<Player>(), new ArrayList<WinCondition>(), true);
    ...
    public void executePower() {
        ...
        aresPower.executePower(player, actionController, chosenBox);
