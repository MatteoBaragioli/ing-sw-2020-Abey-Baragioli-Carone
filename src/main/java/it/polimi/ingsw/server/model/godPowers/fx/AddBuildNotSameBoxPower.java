...
public class AddBuildNotSameBoxPower extends BuildModifier {
    ...
    /**
     * This method initialise new possible builds without the box where player built on in this turn and, if the new list of possible builds is not empty, asks player to use power or not
