...
public class GuiBox extends Button {
    ...
    public void setEffects(MatchPage match, List<int[]> chosableBoxes, int phase){
        ...
        addEventHandler(MouseEvent.MOUSE_CLICKED, event -> {
            ...
            setSelected();
            match.getPlayerView().activateButtons(screenWidth, screenHeight, 1, match);
        });
    }
    ...
    public void setAsChosable(MatchPage match, List<int[]> chosableBoxes, int phase){
        setBlue();
        setDisable(false);
    ...
    public void build(){
        ...
        Image levelImg;
        if(level==4){
            levelImg = new Image(GuiBox.class.getResource("/img/buildingsAndWorkers/levelDome.png").toString());
        }else {
            levelImg = new Image(GuiBox.class.getResource("/img/buildingsAndWorkers/level" + level + ".png").toString());
        }
    ...
    public void remove(){
        level--;
        if(level>0){
            Image levelImg = new Image(GuiBox.class.getResource("/img/buildingsAndWorkers/level" + level + ".png").toString());
            ImageView levelImgView = new ImageView(levelImg);
            levelImgView.setFitWidth(boxWidth - boxWidth / 5);
            levelImgView.setFitHeight(boxHeight - boxHeight / 5);
            building.setGraphic(levelImgView);
    ...
    public void moveWorker(String color, String gender){
        Image workerImg = new Image(GuiBox.class.getResource("/img/buildingsAndWorkers/worker" + gender + color + ".png").toString());
